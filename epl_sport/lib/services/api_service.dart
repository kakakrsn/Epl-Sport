...
class ApiService {
  ...
  Future<List<footballModel.Response>?> getFootball() async {
    final url = 'https://api-football-v1.p.rapidapi.com/v3/players?league=39&season=2020';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final result = footballModel.Football.fromJson(response.data);
